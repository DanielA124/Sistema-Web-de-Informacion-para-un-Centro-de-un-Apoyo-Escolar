  ...
  <div class="card-body">
    <div class="col-md-12">
      <table id="dataTable" class="table table-bordered table-responsive" width="100%" cellspacing="0">           
        ...
        ?>
        <button type="submit" class="btn btn-primary">Agregar Datos de Estudiante</button>
        <?php 
        echo form_close();
        ?>
        <?php echo form_open_multipart('estudiante/deshabilitados'); ?>
        <button type="submit" class="btn btn-warning" name="deshabilitados">Ver Estudiantes Deshabilitados</button>
        <?php 
        echo form_close();
        ?>
    </div>
